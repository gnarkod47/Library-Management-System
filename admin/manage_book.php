    ...
    <div class="col-md-8">
      <table class="table">
        ...
        <?php 
          ...
          $query = "select book_name,author_id,category_id,book_no,book_price from book";
          ...
          while($row = mysqli_fetch_assoc($query_run)){
            ...
            <td>
            <button type="button" class="btn btn-primary"><a style="text-decoration: none; color:white;" href="edit_book.php?bookno=<?php echo $row['book_no'];?>">Edit</a></button>
            <button type="button" class="btn btn-danger"><a style="text-decoration: none; color:white;" href="delete_book.php?bookno=<?php echo $row['book_no'];?>">Delete</a></button>
          </td>
            </tr>
            <?php
          }
