        ...
        <?php 
          ...
          while($row = mysqli_fetch_assoc($query_run)){
            ...
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-primary"><a style="text-decoration: none; color:white;" href="edit_author.php?auth=<?php echo $row['author_id'];?>">Edit</a></button>
                <button type="button" class="btn btn-danger"><a style="text-decoration: none; color:white;" href="delete_author.php?auth=<?php echo $row['author_id'];?>">Delete</a></button>
              </td>
            </tr>
            <?php
          }
